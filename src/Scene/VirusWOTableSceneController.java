	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		WOList = FXCollections.observableArrayList(
				new VirusWOModel("Marburg", "negative polarity RNA, 7 structural proteins",
						false, "https://www.youtube.com/watch?v=TBtWrxZdraw", "no", "viral hemorrhagic fever,die", 7,Data.Marburg),
				new VirusWOModel("Crimean–Congo hemorrhagic fever","circular, negative-sense single stranded RNA",
						...
						"Treatment is mostly supportive","weak,die",4,Data.Crim),
				new VirusWOModel("Ebola",
						"U-shaped, cylindrical/tubular, and contain viral envelope, matrix, and nucleocapsid components.",
						false, "https://www.youtube.com/watch?v=NIhP3YGW6HY", "No antiviral medications have proved effective ", "die", 6,Data.Ebola),
				...
				new VirusWOModel("Nipah", 
						...
						false, "water,air", "no", "neurological disease", 5,Data.Nipah),
				new VirusWOModel("Chikungunya", 
						...
						"Currently, no specific treatment for chikungunya is available.", "pain,hurt body", 2,Data.Chiku),
				new VirusWOModel("Zika", "RNA core, a shell", true, "Aedes aegypti and Asia mosquito", "no specific treatment", 
						" Zika virus infection during pregnancy is a cause of microcephaly.", 2,Data.Zika));
